...
commandType['or'] = C_ARITHMETIC
commandType['not'] = C_ARITHMETIC
commandType['label'] = C_LABEL
commandType['goto'] = C_GOTO
commandType['if-goto'] = C_IF
commandType['push'] = C_PUSH
commandType['pop'] = C_POP
